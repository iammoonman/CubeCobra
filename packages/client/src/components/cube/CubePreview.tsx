  ...
  return (
    <div className="p-2">
      <a
        ...
        className="group block bg-bg-accent shadow border border-border hover:border-border-active overflow-hidden rounded-lg"
      >
        <AspectRatioBox ratio={16 / 9}>
          ...
          <div className="absolute inset-x-0 bottom-0 p-3 flex flex-col gap-1.5">
            <Text bold xl className="text-white block truncate leading-tight">
              {cube.name}
            </Text>
