        ...
        <CardBody>
          <Flexbox direction="col" gap="3">
            ...
            {lastCardUpdate ? (
              ...
              <Text className="text-text-secondary pt-3 border-t border-border">No completed card updates found.</Text>
            )}
          </Flexbox>
        </CardBody>
      </Card>
        ...
        <CardBody>
          <Flexbox direction="col" gap="3">
            ...
            <Text md className="text-text-secondary mt-2">
              These statistics are displayed on individual card pages, allowing you to see how popular each card is, how
              it performs in drafts, and which cards are commonly used alongside it in other cubes. The weekly cadence
              ensures you get fresh data without overwhelming our servers or slowing down the site.
            </Text>
            {lastCardMetadataTask ? (
              <>
                <Flexbox direction="row" gap="4" className="pt-3 border-t border-border">
        ...
        <CardBody>
          <Flexbox direction="col" gap="3">
            ...
            {lastExportTask ? (
              ...
              <Text className="text-text-secondary pt-3 border-t border-border">No completed export tasks found.</Text>
            )}
          </Flexbox>
        </CardBody>
      </Card>
        ...
        <CardBody>
          <Flexbox direction="col" gap="3">
            <Text md className="text-text-secondary">
              ...
              ensure your cubes always use valid, current card data. You'll never see broken images or missing cards due
              to Scryfall's database changes - we handle all the migrations automatically to keep your cubes working
              perfectly.
            </Text>
            {lastMigrationTask ? (
              <>
