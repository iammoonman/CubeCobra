  ...
  <HelpLayout activeHref="/apidocs">
    <Flexbox direction="col" gap="4">
      ...
      <CollapsibleSection id="overview" title="Overview">
        <Flexbox direction="col" gap="3">
          <Text md className="text-text-secondary">
            CubeCobra provides a set of public API endpoints that allow you to programmatically access cube lists, card
            data, search results, and download cube/deck files in a variety of formats. These endpoints are designed for
            tool builders, bot developers, and anyone who wants to integrate CubeCobra data into their own applications.
          </Text>
          <Text md className="text-text-secondary">
          ...
          <ul className="list-disc list-inside space-y-1 text-text-secondary ml-4 text-sm">
            ...
            <li>
              ...
              <InlineCode>Access-Control-Allow-Origin: *</InlineCode> and can be called directly from browser JavaScript
              on any domain.
            </li>
            <li>
      ...
      <CollapsibleSection id="cube-json" title="Cube JSON Export">
        <Flexbox direction="col" gap="4">
          <Text md className="text-text-secondary">
            The primary endpoint for fetching a complete cube as structured JSON data. This is the recommended endpoint
            for integrations that need the full cube card list with metadata.
          </Text>
      ...
      <CollapsibleSection id="rate-limits" title="Rate Limits & Best Practices">
        <Flexbox direction="col" gap="3">
          ...
          <ul className="list-disc list-inside space-y-1 text-text-secondary ml-4 text-sm">
            ...
            <li>
              <span className="font-semibold">Include a User-Agent header</span> identifying your application so we can
              reach out if there are issues.
            </li>
            <li>
              <span className="font-semibold">Respect robots.txt.</span> If scraping pages, respect the robots.txt file.
            </li>
          </ul>
