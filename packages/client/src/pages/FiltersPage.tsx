...
const LAND_SHORTCUTS: { primary: string; alternates?: string[] }[] = [
  { primary: 'bikeland', alternates: ['cycleland', 'bicycleland'] },
  { primary: 'bounceland', alternates: ['karoo'] },
  { primary: 'canopyland', alternates: ['canland'] },
  { primary: 'fetchland' },
  { primary: 'checkland' },
  { primary: 'dual' },
  { primary: 'fastland' },
  ...
  { primary: 'shockland' },
  { primary: 'storageland' },
  { primary: 'creatureland', alternates: ['manland'] },
  { primary: 'triland' },
  { primary: 'tangoland' },
  { primary: 'battleland' },
  { primary: 'surveilland' },
...
const SECTIONS: Section[] = [
  {
    ...
    body: (
      <>
        ...
        <Table
          rows={[
            { query: <code>t:instant OR t:sorcery</code>, description: 'cards that are either instants or sorceries.' },
            { query: <code>t:instant t:tribal</code>, description: 'cards that are both instants and tribal.' },
          ]}
        />
        ...
        <Table
          rows={[
            { query: <code>t:creature o:flash</code>, description: 'cards that are creatures with flash.' },
            {
        ...
        <Table
          rows={[
            { query: <code>-c:w</code>, description: 'cards that are not white.' },
            { query: <code>-o:draw</code>, description: 'cards which do not have draw in their oracle text.' },
            { query: <code>-t:creature</code>, description: 'cards which are not creatures.' },
            { query: <code>-mox</code>, description: 'cards whose names do not include "mox".' },
          ]}
        />
      </>
    ),
    ...
    body: (
      <>
        <p>
          ...
          certain color identity by using <code>ci:</code>, <code>id:</code>, or <code>identity:</code> or{' '}
        ...
        <Table
          rows={[
            { query: <code>c=wubrg</code>, description: 'cards that are all 5 colors.' },
            {
              query: <code>{`c<esper`}</code>,
              description: 'cards who colors are a subset of Esper (UB, WB, WU, U, B, W, or colorless).',
            },
            { query: <code>ci:wu</code>, description: 'cards whose color identities are exactly white blue.' },
            {
              query: <code>{'ci>azorius'}</code>,
              description: 'cards whose color identities contain white, blue, and at least one other color.',
            },
            { query: <code>{'ci>1'}</code>, description: 'cards with more than 1 color in their identity.' },
            { query: <code>{'ci<=3'}</code>, description: 'cards with 3 or fewer colors in their identity.' },
            { query: <code>{'ci:m'}</code>, description: 'cards with more than 1 color in their identity.' },
            { query: <code>{'ci!=m'}</code>, description: 'cards with 1 or less colors in their identity.' },
          ]}
        />
      </>
    ),
  },
  {
    ...
    body: (
      <>
        ...
        <Table
          rows={[
            { query: <code>type=legendary</code>, description: 'cards that are legendary.' },
            { query: <code>t:legendary t:creature</code>, description: 'cards that are legendary creatures.' },
            { query: <code>t:sha</code>, description: 'cards that are shamans, or shapeshifters, spellshapers.' },
            { query: <code>is:spell</code>, description: 'cards that are spells.' },
            { query: <code>is:permanent</code>, description: 'cards that are permanents.' },
          ]}
        />
      </>
    ),
      ...
      <>
        ...
        <Table
          rows={[
            ...
            { query: <code>s:war</code>, description: 'cards from War of the Spark.' },
          ]}
        />
      </>
    ),
  },
  {
    ...
    body: (
      <>
        ...
        <Table
          rows={[
            { query: <code>kw:flying</code>, description: 'cards that have the Flying keyword.' },
            { query: <code>keyword=trample</code>, description: 'cards that have exactly the keyword "Trample".' },
            { query: <code>kw:death</code>, description: 'cards with a keyword containing "death" (e.g. Deathtouch).' },
            { query: <code>{'keywords>3'}</code>, description: 'cards with more than 3 keywords.' },
            { query: <code>keywords=0</code>, description: 'cards with no keywords.' },
          ]}
        />
      </>
    ),
      ...
      <>
        ...
        <Table
          rows={[
            ...
            { query: <code>m:2ww</code>, description: 'cards that cost 2 generic mana, and 2 white mana.' },
            { query: <code>is:gold</code>, description: 'cards that require two or more colors.' },
            { query: <code>is:hybrid</code>, description: 'cards with one or more hybrid mana symbols.' },
            { query: <code>is:phyrexian</code>, description: 'cards with one or more Phyrexian mana symbols.' },
            {
  ...
  },
  {
    ...
    body: (
      <>
        ...
        <Table
          rows={[
            { query: <code>{'mv>5'}</code>, description: 'cards with mana value greater than 5.' },
            { query: <code>mv=3</code>, description: 'cards with mana value of exactly 3.' },
          ]}
        />
      </>
    ),
  },
  {
    ...
    body: (
      <>
        ...
        <p>
          You can use <code>loy:</code> or <code>loyalty:</code> to search for cards with certain starting loyalty.
        </p>
        <p>
          Operators supported: <code>:</code>, <code>=</code>, <code>{'<'}</code>, <code>{'>'}</code>,{' '}
          <code>{'<='}</code>, <code>{'>='}</code>, <code>!=</code>, <code>{'<>'}</code>.
        ...
        <Table
          rows={[
            { query: <code>{'pow>7'}</code>, description: 'cards with greater than 7 power.' },
            {
              query: <code>{'pow<5 tou<5'}</code>,
              description: 'cards with both less than 5 power, and less than 5 toughness.',
            },
            { query: <code>{'pow>toughness'}</code>, description: 'cards with power greater than toughness.' },
            { query: <code>{'tou!=power'}</code>, description: 'cards with toughness not equal to power.' },
            { query: <code>loy:3 or loy:4</code>, description: 'cards with a starting loyalty of 3 or 4.' },
          ]}
        />
      </>
    ),
  },
  {
    ...
    body: (
      <>
        ...
        <Table
          rows={[
            { query: <code>r:common</code>, description: 'Common cards.' },
            { query: <code>{'r<=uncommon'}</code>, description: 'Common or uncommon cards.' },
            { query: <code>r:common or r:rare</code>, description: 'Common or rare cards.' },
          ]}
        />
      </>
    ),
      ...
      <>
        ...
        <Table
          rows={[
            ...
            { query: <code>is:firstprint</code>, description: 'All first printings of cards.' },
          ]}
        />
      </>
    ),
  },
  {
    ...
    body: (
      <>
        ...
        <Table
          rows={[
            { query: <code>d:www</code>, description: 'All cards with exactly 3 white devotion.' },
            { query: <code>{'devotiontor>2'}</code>, description: 'All cards with more than 2 devotion to red.' },
          ]}
        />
      </>
    ),
      ...
      <>
        ...
        <Table
          rows={[
            ...
            { query: <code>tags=0</code>, description: 'All cards with no tags.' },
            { query: <code>{'tags>0'}</code>, description: 'All cards with at least one tag.' },
          ]}
        />
      </>
    ),
      ...
      <>
        ...
        <Table
          rows={[
            ...
            { query: <code>{`notes!=''`}</code>, description: 'All cards with non-empty notes.' },
          ]}
        />
      </>
    ),
    ...
    body: (
      <>
        <p>
          ...
          Also <code>banned:</code>, <code>ban:</code>, or <code>restricted:</code> to check inversely. The format name
          can also be double-quoted.
        </p>
        <Text semibold>Examples:</Text>
        <Table
          rows={[
            { query: <code>leg:Modern</code>, description: 'All cards that are legal in Modern.' },
            { query: <code>-leg:Standard</code>, description: 'All cards that are not legal in Standard.' },
            { query: <code>banned:Modern</code>, description: 'All cards that are banned in Modern.' },
            {
              query: <code>restricted:"Vintage"</code>,
              description: 'All cards that are restricted in Vintage (the only format with restrictions currently).',
            },
            { query: <code>is:commander</code>, description: 'All cards that can be your commander.' },
            { query: <code>is:reserved</code>, description: 'All cards that are on the reserved list.' },
            {
            ...
            },
            {
              ...
              description: 'All cards whose current printing is available on arena (checks only the specific version).',
            },
          ]}
        />
      </>
      ...
      <>
        ...
        <Table
          rows={[
            ...
            { query: <code>double_faced_token</code>, description: 'Tokens with another token printed on the back' },
  ...
  {
    id: 'border-frame-foil',
    title: 'Border, Frame, Foil & Resolution',
    body: (
      <>
        <p>
        ...
        <Table
          rows={[
            { query: <code>finish:non-foil</code>, description: 'All cards with the non-foil finish selected.' },
            { query: <code>is:fullart</code>, description: 'All cards with full extended art.' },
            {
  ...
  {
    id: 'first-print-year',
    title: 'First Print Year',
    body: (
      <>
        <p>
          You can use <code>year:</code>, <code>firstyear:</code>, or <code>fy:</code> to search for cards by the year
        ...
        <Table
          rows={[
            { query: <code>{'year>2020'}</code>, description: 'cards first printed after 2020.' },
            { query: <code>fy=1993</code>, description: 'cards first printed in 1993 (Alpha/Beta era).' },
            { query: <code>{'firstyear<=2000'}</code>, description: 'cards first printed in 2000 or earlier.' },
            {
  ...
  },
  {
    ...
    body: (
      <>
        ...
        <Table
          rows={[
            { query: <code>{'elo>1500'}</code>, description: 'All cards with an elo rating above 1500.' },
            {
  ...
  <HelpLayout activeHref="/help/filters">
    <Flexbox direction="col" gap="3">
      <Card>
        ...
        <CardBody>
          <Text semibold className="mb-2 block">
            Jump to a section:
          </Text>
          <ul className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-4 gap-y-1 list-none p-0 m-0">
            {SECTIONS.map(({ id, title }) => (
              <li key={id}>
                <a href={`#${id}`} className="text-link hover:text-link-active">
                  {title}
                </a>
              </li>
            ))}
